...
class Pokemon_2 {
     ...
     */
    public Pokemon_2(String name, String type, int health_max) {
        this.name = name;
        this.type = type;
        if (health_max > 0) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Samson.sayHello("Samson"));

        Samson instance = new Samson("Samson");
